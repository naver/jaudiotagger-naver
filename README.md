...
This is forked from jaudiotagger v2.2.3 branch for Android Compatibility. We have made some minor changes on MP3File.java that uses `ByteBuffer` instead of `FileChannel` to avoid nio error on Android ICS and JB.

Jaudiotagger repo : https://bitbucket.org/ijabz/jaudiotagger
